...
namespace Lab7
{
    class Equation
    {
        ...
        public static bool operator true(Equation calculating)
        {
            return calculating.CalculateRoots();
        }
        ...
        public static Equation operator +(Equation lhs, Equation rhs)
            => new Equation(lhs.a + rhs.a, lhs.b + rhs.b, lhs.c + rhs.c);
